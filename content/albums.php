...
<html lang="en-US" dir="ltr">
  ...
  <body>
    <main class="main" id="top">
      ...
      $catName = $_GET['catDesc'];
      $catID = $_GET['catID'];
      $sql = "SELECT CDID, CDTitle FROM tiptop_cd WHERE catID = ?";
        ...
        <div class="container">
          <div class="row h-100">
            <div class="col-lg-7 mx-auto text-center mb-6">
              <?php
              echo("<h5 class='fw-bold fs-3 fs-lg-5 lh-sm mb-3'>$catName</h5>");
              ?>
            </div>
          </div>
          <div class="row gx-2">
            ...
            if ($stmt = mysqli_prepare($conn, $sql)){
              ...
              mysqli_stmt_bind_result($stmt, $CDID, $CDTitle);
              while (mysqli_stmt_fetch($stmt)){
                echo("<a href='song.php?CDID=$CDID' class='list-group-item list-group-item-action'>$CDTitle</a>");
              }
