        ...
        <div class="container">
          <div class="row h-100">
            <div class="col-lg-7 mx-auto text-center mb-6">
              <h5 class="fw-bold fs-3 fs-lg-5 lh-sm mb-3">Music Categories</h5>
            </div>
          </div>
          <div class="row gx-2">
            <div class="col-sm-6 col-md-4 col-lg-3 h-100 mb-5">
              <?php
              $sql = "SELECT * FROM `tiptop_category` WHERE catDesc != ''";
                ...
                echo ("<div class='card-body'>");
                  echo("<div class='d-flex align-items-center'>");
                    echo("<div class='flex-1'>");
                      echo("<h5 class='text-light'><a href ='albums.php?catDesc=$catName&catID=$catID'>$catName</a></h5>");
                    echo("</div>");
                echo("</div>");
              echo("</div>");
              }
