        ...
        <div class="container">
          <div class="row h-100">
            <div class="col-lg-7 mx-auto text-center mb-6">
              <h5 class="fw-bold fs-3 fs-lg-5 lh-sm mb-3">All users</h5>
            </div>
          </div>
          <div class="row gx-2">
          <?php
              $sql = "SELECT * FROM `tiptop_user` WHERE admin = 'N' ORDER BY username";
              ...
              while($row = mysqli_fetch_assoc($queryResult)){
                ...
                echo("<h5 class='text-bold'>$userName</h5>");
                echo("</div>");
                echo("</div>");
                echo("</div>");
                echo("</div>");
                ...
                echo("<div class='col-sm-6 col-md-4 col-lg-3 h-100 mb-5'>");
                echo("<div class='card-body'>");
                echo("<h5 class='text-bold'>$stt Review(s) </h5>");
                echo("</div>");
                echo("</div>");
                ...
                echo("<div class='col-sm-6 col-md-4 col-lg-3 h-100 mb-5'>");
                echo("<div class='card-body'>");
                echo("<h5 class='text-light'><a href ='\KF7013\content\comments.php?userID=$userID&userName=$userName'>See the user's reviews</a></h5>");
                echo("</div>");
                echo("</div>");

                echo("<div class='col-sm-6 col-md-4 col-lg-3 h-100 mb-5'>");
                echo("<div class='card-body'>");
                echo("<h5 class='text-light'><a href ='\KF7013\content\delete_user.php?userID=$userID\'>Delete</a></h5>");
                echo("</div>");
                echo("</div>");
